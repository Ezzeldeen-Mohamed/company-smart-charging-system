...
namespace CompanySmartChargingSystem.Tests
{
    public class UnitTests
    {
        ...
        //        var roles = new List<string> { "User" };
        //        var RefreshTokenModel = new RefreshTokenModel { Token = "refresh123", Expiration = DateTime.UtcNow.AddDays(7), isNew = true };
        ...
        //        _jwtServiceMock.Setup(j => j.CheckAndCreateNewRefreshToken(user)).Returns(RefreshTokenModel);
        ...
        //        Assert.Equal(RefreshTokenModel.Token, authResponse.RefreshTokenModel);
        ...
        //        var roles = new List<string> { "User" };
        //        var RefreshTokenModel = new RefreshTokenModel { Token = "refresh123", Expiration = DateTime.UtcNow.AddDays(7) };
        ...
        //        _jwtServiceMock.Setup(j => j.GenerateRefreshToken()).Returns(RefreshTokenModel);
